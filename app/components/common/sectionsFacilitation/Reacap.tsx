...
export default function Recap() {
  return (
    <div className="relative mt-48 md:mt-48">
      <Image
        src="/wordKey/Recap.svg"
        alt="work recap"
        width={393}
        height={239}
        className=" absolute md:left-10 -top-44 z-10 pointer-events-none"
        aria-hidden="true"
      />

      <div className="bg-[#C7D0FF] relative md:rounded-[80px] rounded-3xl flex flex-col md:flex-row md:px-20 px-6 py-12 md:gap-10 gap-8 items-center justify-center overflow-hidden">
        ...
        <Image
          src="/wordKey/Rec_circle_logo.svg"
          alt="Session recap illustration"
          width={390}
          height={390}
