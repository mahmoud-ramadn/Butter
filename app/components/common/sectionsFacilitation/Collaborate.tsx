...
export default function Collaborate() {
  return (
    <div className="  bg-violet-200 md:rounded-[80px] rounded-3xl  relative  mt-40 md:mt-72">
      <div className=" relative flex flex-col md:flex-row md:px-20 px-6 py-12 md:gap-10 gap-8 items-center justify-center overflow-hidden">
        ...
        <Image
          src="/wordKey/collaborate-two.svg"
      ...
      <Image
        src="/wordKey/collaborate.svg"
        alt=""
        width={1095}
        height={240}
        className=" absolute md:right-10 md:-top-80    -top-[120px]  z-10 pointer-events-none"
        aria-hidden="true"
      />
    </div>
  );
